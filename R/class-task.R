...
Task <- setRefClass("Task", contains = "Item",
                    ...
                    fields = list(id               = "character_OR_NULL",
                                  ...
                                  status           = "character_OR_NULL",
                                  app              = "character_OR_NULL",
                                  type             = "character_OR_NULL",
                                  created_by       = "character_OR_NULL",
                                  executed_by      = "character_OR_NULL",
                                  start_time       = "character_OR_NULL",
                                  end_time         = "character_OR_NULL",
