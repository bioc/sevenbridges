...
SBG <- setRefClass("SBG", contains  = "CWL",
                   ...
                   fields = list(
                       "sbg:homepage"            = "character_OR_NULL",
                       "sbg:validationErrors"    = "listORNULL",
                       "sbg:sbgMaintained"       = "logicalORNULL",
                       "sbg:latestRevision"      = "integerORNULL",
                       "sbg:job"                 = "listORNULL",
                       "sbg:toolAuthor"          = "character_OR_NULL",
                       "sbg:copyOf"              = "character_OR_NULL",
                       "sbg:createdOn"           = "integerORNULL",
                       "sbg:categories"          = "characterORlistORNULL",
                       "sbg:contributors"        = "listORNULL",
                       "sbg:links"               = "listORNULL",
                       "sbg:project"             = "character_OR_NULL",
                       "sbg:projectId"           = "character_OR_NULL",
                       "sbg:createdBy"           = "character_OR_NULL",
                       "sbg:toolkitVersion"      = "character_OR_NULL",
                       "sbg:id"                  = "character_OR_NULL",
                       "sbg:license"             = "character_OR_NULL",
                       "sbg:revision"            = "integerORNULL",
                       "sbg:revisionNotes"       = "character_OR_NULL",
                       "sbg:cmdPreview"          = "character_OR_NULL",
                       "sbg:modifiedOn"          = "integerORNULL",
                       "sbg:modifiedBy"          = "character_OR_NULL",
                       "sbg:revisionsInfo"       = "listORNULL",
                       "sbg:toolkit"             = "character_OR_NULL",
                       "sbg:image_url"           = "character_OR_NULL",
                       "sbg:updateRevisionNotes" = "character_OR_NULL",
                       "sbg:updateModifiedBy"    = "character_OR_NULL",
                       "sbg:update"              = "character_OR_NULL"
                   ),
